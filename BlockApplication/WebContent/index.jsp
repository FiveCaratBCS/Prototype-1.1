...
<body>
	...
	<fieldset>
		...
		<div id="div_refresh">
			...
			<c:if test = "${block.size != null}">
				...
				<h3 style="display:none"> Blocks :  ${block.size} </h3>
					...
					<c:forEach items="${list}" var="l" varStatus="divCounter">
						...
						<!--<textarea rows="4" cols="50">Index Value:${l.id}, Data:${l.data}, Hash Value:${l.hash}, Previous Hash:${l.previous_Hash}, Timestamp:${l.time_stamp}
						...
						<c:if test = "${divCounter.count % block.transaction_count == 1}">
							...
							<div id="block">
								...
								<p><span id="name">Index :</span> <span id="value">${l.id}</span>, <span id="name">Data :</span> <span id="value">${l.data}</span>, <span id="name">Hash :</span> <span id="value">${l.hash}</span>, <span id="name">Previous Hash :</span> <span id="value">${l.previous_Hash}</span>, <span id="name">Timestamp :</span> <span id="value">${l.time_stamp}</span></p>
			...
			<form name="inarea" action="blockServlet" method="get">
